...
PROJECT_NAME = 'cosmo'
# in this format, 'VERSION' can be updated by the Makefile template in
# https://tfinternal.research.cchmc.org/gitlab/sysadmin/makefile-templates
VERSION = '1.1.0'
GITLAB = 'https://tfinternal.research.cchmc.org/gitlab'
GITLAB_PROJECT = GITLAB + '/weirauchlab/' + PROJECT_NAME
...
setup(
    ...
    project_urls={
        "Bug Tracker": GITLAB_PROJECT + '/issues',
        "Documentation": GITLAB_PROJECT + '#readme',
        "Source Code": GITLAB_PROJECT,
    },
